...
def preprocessed_data():
    ...
    df = pd.read_csv("data/ccRCC_TMT_intact glycopeptide_abundance_MD-MAD_50percentQuant_imputed.tsv", sep="\t")
    ...
    biospecimen = pd.read_csv("data/PDC_study_biospecimen_09182023_104440.tsv", sep="\t")
    ...
    clinical = pd.read_csv("data/PDC_study_clinical_09182023_105327.tsv", sep="\t")
    ...
    clinical_exposure = pd.read_csv("data/PDC_study_clinical_exposure_09182023_105327.tsv", sep="\t")
    ...
    clinical_followup = pd.read_csv("data/PDC_study_clinical_followup_09182023_105327.tsv", sep="\t")
